...
-- /___/   /\     Timestamp: Wed Feb 17 14:28:42 2010
-- \   \  /  \ 
--  \___\/\___\
--             
...
architecture STRUCTURE of fifo_sequence is
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000062_355 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000062_354 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000158_353 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000063_352 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000156_351 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000115_350 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000026_349 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000158_348 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000063_347 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000156_346 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000115_345 : STD_LOGIC; 
  signal BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000026_344 : STD_LOGIC; 
...
begin
  ...
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000158 : LUT4_L
    generic map(
      INIT => X"9000"
    )
    port map (
      ...
      I2 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000156_351,
      I3 => BU2_U0_grf_rf_gl0_rd_rpntr_count_not0001,
      LO => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000158_353
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000158 : LUT4_L
    ...
    port map (
      ...
      I2 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000156_346,
      I3 => BU2_U0_grf_rf_gl0_wr_wpntr_count_not0001,
      LO => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000158_348
    );
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000062 : LUT4_L
    generic map(
      INIT => X"9009"
    )
    port map (
      ...
      LO => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000062_355
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000062 : LUT4_L
    ...
    port map (
      ...
      LO => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000062_354
    );
  BU2_U0_grf_rf_gl0_rd_rpntr_Mcount_count_xor_3_111 : LUT3_L
    generic map(
      INIT => X"7F"
    )
    port map (
      ...
      LO => BU2_U0_grf_rf_gl0_rd_rpntr_N11
    );
  BU2_U0_grf_rf_gl0_wr_wpntr_Mcount_count_xor_3_111 : LUT3_L
    generic map(
      INIT => X"7F"
    )
    port map (
      ...
      LO => BU2_U0_grf_rf_gl0_wr_wpntr_N11
    );
  BU2_U0_grf_rf_gcx_clkx_rd_pntr_bin_xor0003_SW0 : LUT2_L
    generic map(
      INIT => X"6"
    )
    port map (
  ...
  BU2_U0_grf_rf_gcx_clkx_wr_pntr_bin_xor0003_SW0 : LUT2_L
    generic map(
      INIT => X"6"
    )
    port map (
...
NLW_BU2_U0_grf_rf_mem_gbm_gbmg_gbmga_ngecc_bmg_blk_mem_generator_valid_cstr_ramloop_0_ram_r_v4_noinit_ram_SDP_SINGLE_PRIM_SDP_DOPA_0_UNCONNECTED,
  ...
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000063 : LUT3
    generic map(
      INIT => X"90"
    )
    port map (
      ...
      I2 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000062_355,
      O => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000063_352
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000063 : LUT3
    ...
    port map (
      ...
      I2 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000062_354,
      O => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000063_347
    );
  ...
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000183 : LUT4
    ...
    port map (
      I0 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000115_350,
      I1 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000026_349,
      I2 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000063_352,
      I3 => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000158_353,
  ...
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000156 : LUT4
    ...
    port map (
      ...
      O => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000156_351
    );
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000115 : LUT4
    ...
    port map (
      ...
      O => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or0000115_350
    );
  BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000026 : LUT4
    ...
    port map (
      ...
      I3 => BU2_U0_grf_rf_gcx_clkx_wr_pntr_bin(1),
      O => BU2_U0_grf_rf_gl0_rd_gras_rsts_ram_empty_fb_i_or000026_349
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000183 : LUT4
    ...
    port map (
      I0 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000026_344,
      I1 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000063_347,
      I2 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000115_345,
      I3 => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000158_348,
  ...
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000156 : LUT4
    ...
    port map (
      ...
      O => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000156_346
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000115 : LUT4
    ...
    port map (
      ...
      O => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or0000115_345
    );
  BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000026 : LUT4
    ...
    port map (
      ...
      I3 => BU2_U0_grf_rf_gcx_clkx_rd_pntr_bin(1),
      O => BU2_U0_grf_rf_gl0_wr_gwas_wsts_ram_full_i_or000026_344
    );
